...
public ResponseEntity<ApiResponse> getAllAccountsByCustomerId(@PathVariable("customerId") int customerId) throws Exception
{
...
public ResponseEntity<ApiResponse>deleteAccount(@PathVariable("emailId") String emailId, @PathVariable("password") String password,@PathVariable("accountNumber") int accountNumber){
...
public ResponseEntity<ApiResponse> getAllAccountsByCustomerEmailId(@PathVariable("emailId") @Valid @NotBlank(message = "emailId name should not be blank")
...
public ResponseEntity<ApiResponse> getAllAccountsLessThanOpeningBalance(@PathVariable("opBal") double opBal) throws Exception
{
...
public ResponseEntity<ApiResponse> findDistinctByAccountTypeAndOpeningBalance(@PathVariable("accType") String accType,@PathVariable("opBal") double opBal) throws Exception
{
